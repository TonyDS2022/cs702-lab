...
def run_simulation(policy, num_episodes=1000):
    ...
    return {
        ...
        "avg_cumulative_reward": total_reward / num_episodes
    }
...
print(f"{'Avg Episode Length':<30} {seq_results['avg_episode_length']:>14.2f} {sim_results['avg_episode_length']:>14.2f}")
print(f"{'Avg Cumulative Reward':<30} {seq_results['avg_cumulative_reward']:>14.2f} {sim_results['avg_cumulative_reward']:>14.2f}")
print("-" * 60)
